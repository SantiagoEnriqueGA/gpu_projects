...
def run_cpu_avg(size_multi=2, max_iters=50):
    """Run the Mandelbrot fractal on the CPU and calculate the average execution time."""
...
def run_gpu_cuda_avg(size_multi=2, max_iters=50):
    """Run the Mandelbrot fractal on the GPU using Numba and calculate the average execution time."""
    width = 750 * size_multi
    height = 500 * size_multi
...
def run_gpu_opencl_avg(size_multi=2, max_iters=50):
    """Run the Mandelbrot fractal on the GPU using PyOpenCL and calculate the average execution time."""
    width = 750 * size_multi
    height = 500 * size_multi
    image = np.zeros((height, width), dtype=np.uint8)
