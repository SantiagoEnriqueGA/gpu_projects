...
def run_cpu(size_multi=2, max_iters=50, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.imsave(f"julia_set/plots/cpu_julia_size{size_multi}_iters{max_iters}.png", image, dpi=3000)
    return image
...
def run_gpu_cuda(size_multi=2, max_iters=50, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.imsave(f"julia_set/plots/cuda_julia_size{size_multi}_iters{max_iters}.png", image, dpi=3000)
    return image
...
def run_gpu_opencl(size_multi=2, max_iters=50, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.imsave(f"julia_set/plots/opencl_julia_size{size_multi}_iters{max_iters}.png", image, dpi=3000)
    return image
...
def run_gpu_cupy(size_multi, max_iters, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.imsave(f"julia_set/plots/cupy_julia_size{size_multi}_iters{max_iters}.png", image, dpi=3000)
    return image
